...
<div class="uk-section uk-background-secondary uk-padding-remove-vertical">
	<div class="uk-container uk-container-large uk-padding-small">
		...
		<div class="uk-grid-collapse uk-child-width-expand@s uk-text-center" uk-grid>
			...
			<div>
				<p class="uk-margin-remove uk-text-bold uk-text-small uk-text-capitalize uk-light"> Built with <a href="http://getuikit.com" title="Visit UIkit 3 site" target="_blank" uk-tooltip><span uk-icon="uikit"></span> UIkit 3</a></p>
			</div>
		</div>	
	</div>
</div>
...
<ul class="uk-list">
<li><a uk-tooltip="Menu" class="uk-visible@m" uk-toggle="target: #left-col"><span class="uk-icon-button uk-button-warning uk-icon" uk-icon="thumbnails"></span></a></li>
    <li><a uk-tooltip="Menu" class="uk-hidden@m" uk-toggle="target: #sidebar-offcanvas"><span class="uk-icon-button uk-button-warning uk-icon" uk-icon="thumbnails"></span></a></li>
    <li><a uk-tooltip="to Top" class="uk-icon-button uk-box-shadow-medium uk-link-text" href="#" uk-icon="ratio: 1.2" uk-totop uk-scroll></a></li>
</ul>
