...
<div class="uk-card uk-margin-bottom uk-card-default">
				...
				<tr>
					...
					<td class="centerall">
						...
						<!-- IF !{ADMIN_RIGHTSBYITEM_ROW_ITEMS_LOCKED} -->
							<input type="checkbox" class="checkbox uk-checkbox" name="{ADMIN_RIGHTSBYITEM_ROW_ITEMS_NAME}"{ADMIN_RIGHTSBYITEM_ROW_ITEMS_CHECKED}{ADMIN_RIGHTSBYITEM_ROW_ITEMS_DISABLED} />
						<!-- ENDIF -->
					</td>
					<!-- END: ROW_ITEMS -->
					<td class="action">
...
<div class="uk-child-width-expand@s uk-text-center" uk-grid>
    ...
    <div>
        <input type="submit" class="submit uk-button uk-button-primary" value="{PHP.L.Update}" />
    </div>
</div>
