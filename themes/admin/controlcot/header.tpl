...
<div id="sidebar-offcanvas" uk-offcanvas="overlay: true">
	<div class="uk-offcanvas-bar uk-section-secondary uk-flex uk-flex-column">
		{FILE "{PHP.cfg.themes_dir}/admin/{PHP.cfg.admintheme}/inc/uk-nav-side.tpl"}
	</div>
</div>

<div id="menu-offcanvas" uk-offcanvas="flip: true; mode: push; overlay: true;">
	<div class="uk-offcanvas-bar uk-flex uk-flex-column">
		<button class="uk-offcanvas-close" type="button" uk-close></button>
		<ul class="uk-nav-primary uk-nav-parent-icon uk-nav-center uk-margin-auto-vertical" uk-nav>
			<li class="uk-active"><a href="">Home</a></li>
      <li><a class="navbar-link" target="_blank" href="{PHP|cot_url('index')}" title="Открыть {PHP.cfg.mainurl}">Перейти на сайт</a></li>
      <li><a class="navbar-link" href="{PHP.sys.xk|cot_url('login', 'out=1&x=$this')}">{PHP.L.Logout}</a></li>
		</ul>
	</div>
</div>
...
<a class="uk-navbar-item uk-hidden@m" uk-toggle="target: #sidebar-offcanvas">
			...
			<a class="uk-navbar-item uk-visible@m" uk-toggle="target: #left-col">
				<span class="uk-icon-button uk-text-warning" uk-icon="thumbnails"></span>
			</a>
			<a class="uk-navbar-item uk-logo" href="{PHP|cot_url('admin')}">
				{PHP.cfg.maintitle}
			</a>
			</div>
			<div class="uk-navbar-right">
				<ul class="uk-navbar-nav">
					...
					<li class="uk-visible@s">
						<a class="navbar-link" target="_blank" href="{PHP|cot_url('index')}" title="Открыть {PHP.cfg.mainurl}">Перейти на сайт</a>
					</li>
					<li class="uk-visible@s">
