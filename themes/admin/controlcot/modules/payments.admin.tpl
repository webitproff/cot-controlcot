	...
	<tr>
		...
		<td>
		  <a class="uk-link-heading" uk-tooltip="Страница пользователя" href="{PAY_ROW_USER_DETAILSLINK}">
		    ...
		    <!-- ELSE -->
		    <img class="uk-preserve-width uk-border-rounded" src="{PHP.cfg.mainurl}/{PHP.cfg.themes_dir}/admin/{PHP.cfg.admintheme}/img/avatar.png" width="50" height="50" alt="">
		    <!-- ENDIF -->
		  </a>
		</td>
		<td>
...
<!-- BEGIN: TRANSFERS -->
				<div class="uk-overflow-auto">
				  <table class="uk-table uk-table-striped uk-table-hover uk-table-middle uk-table-divider uk-background-default">
				    <thead class="uk-background-secondary uk-light">
	<tr>
		<th class="uk-table-shrink"><span class="uk-text-bold uk-light">{PHP.L.payments_balance_transfers_from}</span></th>
